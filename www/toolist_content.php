...
try
{
	...
	foreach($data['results']['bindings'] as $result) {
		...
		if (strlen($description) > $limit) {
			$desc_short = substr($description, 0, $limit);
		...
		<div class="instance_row">
			  ...
			  <div id="<?php echo $label; ?>" style="display:none;"><?php echo $description; ?><a id="more_info" href="http://toolmatch.esipfed.org/tool.php?uri=<?php echo $tool; ?>">See Full Info</a><br/><br/></div>
		  </div>
		<?php }
} 
catch( Exception $e )
